class StudentReviewController < ApplicationController
  ...
  #The list function has been been refractored into list_review and list_meta_review
  def list
    ...
    list_review(@assignment)
    list_meta_review (@assignment)
  end  

  # Calculates the reviews completed or in progress for a given assignment
   def list_review(assignment)
  ...
  # Calculates the metareviews completed or in progress for a given assignment
  def list_meta_review (assignment)
    @assignment=assignment
